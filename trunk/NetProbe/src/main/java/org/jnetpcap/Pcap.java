 ...
 * then capture processing some packets captured as a result. This is all loosely
...
public class Pcap {
	 ...
	 * supported, and, on other platforms, the timer doesn't capture until at
	 ...
	 * supplied buffer where the capture of the packet is buffer's current
	 ...
	 * PcapStat structure. The values represent packet statistics from the capture
