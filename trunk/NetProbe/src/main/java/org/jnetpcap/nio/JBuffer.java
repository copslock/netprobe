...
public class JBuffer extends JMemory {
	 ...
	 * 
	 * @param index
	 *          byte index into the buffer to capture
	 * @param buf
	 ...
	 * @param dstOffset
	 *          offset into this buffer where to capture the copy
	 * @return number of bytes copied
	 */
	@Override
	 ...
	 * @param srcOffset
	 *          offset into the source buffer where to capture copy from
	 * @param length
	 *          number of bytes to copy
	 * @param dstOffset
	 *          offset into the destination buffer where to capture copy to
	 * @return number of bytes copied
	 */
	@Override
	public int transferTo(final JBuffer dst,
