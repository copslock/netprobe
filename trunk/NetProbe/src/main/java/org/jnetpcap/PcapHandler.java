...
public interface PcapHandler<T> {
	 ...
	 * follows. The position property is set to the capture of the packet data and
	 ...
	 * properties are adjusted. The buffer may wrap around and capture from the
	 * capture as determined by libpcap itself. Also the buffer is read-only and the
