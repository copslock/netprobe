...
public abstract class JHeader extends JBuffer implements JPayloadAccessor {
	 ...
	 * get header's length. The method is given a buffer and offset as the capture
	...
	/**
	 * Gets the offset in bytes into the packet, of the capture of the header. *
	 * 
	 * <pre>
	 * +---------========--------------------------+
	 * | prefix | HEADER | gap | payload | postfix |
	 ...
	 * </pre>
	 * 
	 * @return the capture of the payload within the packet buffer
	 */
	...
	/**
	 * Gets the offset in bytes into the packet buffer of the capture of the
	 ...
	 * packet right after the current header. The copy will capture at the current
